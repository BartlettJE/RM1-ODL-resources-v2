...
We use the group work agreement to outline how you and your group will work and communicate with each other, and ensure you are engaging in the group work process for the [stage one group report](#stage1-AIS). Groups typically experience problems when communication and task responsibilities are built on unspoken assumptions. As you might not know the people in your group when we make the allocations, we start the project by facilitating a discussion with you and your group so you can openly outline how you will communicate, [respect diversity](#group-work-advice), and [split tasks](#stageone-planning). 
...
- This task takes place in **Semester 2**. 

- The deadline is **`r groupagreement_due`**, where everyone in the group must submit an individual signed copy of the agreement you worked on.
...
- DO: Create a Microsoft Planner with all members of your group to assign individual tasks (we recommend copying [this Planner template for the stage one group report](https://tasks.office.com/gla.onmicrosoft.com/Home/PlanViews/p_04y5UClU-Hq1qwx0gN65YACpzm?Type=PlanLink&Channel=Link&CreatedTime=638616394371860000){target="_blank"} we have created. Please copy the Planner, do not edit it.).

- DON’T: Use WhatsApp, Facebook or WeChat etc. to coordinate your project as that excludes people who cannot access this technology in some countries.
...
- DON’T: Commit to meetings/time frames that will not work for your timetable or work schedule. 
...
- DO: Think about a shared Zotero, EndNote, or similar reference manager to organise papers.

**Work back from the deadline to create milestones**

- DO: Be mindful of your work/life balance and upcoming busy periods.

- DO: Agree on specific dates to complete your responsibilities.

- DON’T: Leave things to the last minute.

**Determine strengths and assign roles**

- DO: Consult the [Stage one group work planning advice section below](#stageone-planning) to identify the strengths/preferences of your team.

**Assign tasks/milestones to roles** 

- DO: Attach names and dates to tasks and assign milestones using the Microsoft Planner template.

- DO: Reassign tasks/adjust deadlines as the project progresses if you need to.
...
- DO: Agree to action points at the end of meetings and put these in writing (e.g., in a shared document / to-do list).
...
You might choose to separate the tasks differently, but this is one suggestion to work through. We support this [the Planner template for the stage one group report](https://tasks.office.com/gla.onmicrosoft.com/Home/PlanViews/p_04y5UClU-Hq1qwx0gN65YACpzm?Type=PlanLink&Channel=Link&CreatedTime=638616394371860000){target="_blank"}, so we recommend at least starting with this plan and allocate roles, and then adapt as you need. 

For this separation or another approach you agree in your group, question what you know, what you still need to think about, and how you will fill in the blanks:
...
You can either copy and adapt these questions to work on in your own document, copy [the Planner template](https://tasks.office.com/gla.onmicrosoft.com/Home/PlanViews/p_04y5UClU-Hq1qwx0gN65YACpzm?Type=PlanLink&Channel=Link&CreatedTime=638616394371860000){target="_blank"} to your own Microsoft University account, or [download this template](Supporting/Stage One Report Task Sharing.docx) to structure your group discussions. 
