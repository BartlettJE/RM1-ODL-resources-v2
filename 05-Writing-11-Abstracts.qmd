...
We have three different versions of an abstract and we would like you to read through them and decide a) what is the order of best to worst, and b) how would you improve the best one? We will create a post on Teams to host the discussion and we will provide formative feedback after a week or so. The key to this task is thinking about the comparison between the versions, so be sure to actively make notes on what made one version better than another. 
