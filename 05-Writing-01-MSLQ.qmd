...
The MSLQ has two sections, motivation and learning strategies, each with multiple sub-scales. One of these scales may form part of the analysis you write up. There is more information about what each of these scales measures in the MSLQ Overview document, which you can [download using this link](Supporting/MSLQ Overview.docx), or you can find it in the Semester 2 Week 1 content.
...
::: {.callout-tip}
#### Try this
Now you have read through the MSLQ and project overview, think about which variable pairs interest you the most and complete the group preference form (available on Moodle and Teams). We will finalise groups at the end of semester 2 week 1, so you have as much time as possible to work on your group project. 
:::
