...
We will not ask you anything that has not been covered yet in either the lectures or the [Fundamentals of Quantitative Analysis](https://psyteachr.github.io/quant-fun-v3/){target="_blank"} data skills book. For example, data skills 1 would focus on material from weeks 1 to 8, and **would not** expect you to know content covered after week 9 or later. 
...
- These assessments take place in **Semester 1**. 
